 ...
 * 修改备注：
 */
public class ControlSocketEListViewAdapter extends BaseExpandableListAdapter {

    private ControlActivity mcontext;
    private ControlApiBean controlLampApiBean;

    public ControlSocketEListViewAdapter(ControlActivity mcontext, ControlApiBean controlLampApiBean) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        viewHolder.controlElistItemGroupSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                SocketOnOff(GsonUtil.GsonString(controlParameter));
